...
class DataaSetViewer:
    ...
    def create_ui (self):
        ...
        #define columns
        columns = ('Avg. Area Income', 'Avg. Area House Age', 'Avg. Area Number of Rooms', 'Avg. Area Number of Bedrooms',
    ...
    def show_data_listview(self,fileName):
        ...
        for i in range (0,len(df)):
            values = [df.iloc[i][0], df.iloc[i][1], df.iloc[i][2], df.iloc[i][3],
